...
const Banner = () => {
  return (
    <div className=" bg-[#EFEFEF] py-4 md:py-10">
      <div className=" max-w-11/12 mx-auto min-h-screen border-3 border-white rounded-3xl bg-gradient-to-b from-white/10 to-white backdrop-blur-md">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center p-2 mt-10">
          <img
